...
static unsigned int g_ppe_rule = 0;
...
void ipq6018_ppe_provision_init(void)
{
	...
	g_ppe_rule = 0;
	ipq6018_ppe_acl_set(g_ppe_rule++, ADPT_ACL_HPPE_IPV4_DIP_RULE, UDP_PKT, 67, 0xffff, 0, 0);
	ipq6018_ppe_acl_set(g_ppe_rule++, ADPT_ACL_HPPE_IPV4_DIP_RULE, UDP_PKT, 68, 0xffff, 0, 0);
#if defined(CONFIG_ASUS_PRODUCT)
	/* Allowing Firmware Restoration packets */
	ipq6018_ppe_acl_set(g_ppe_rule++, ADPT_ACL_HPPE_IPV4_DIP_RULE, UDP_PKT, 69, 0xffff, 0, 0);
#endif
	/* Dropping all the UDP packets */
	ipq6018_ppe_acl_set(g_ppe_rule++, ADPT_ACL_HPPE_IPV4_DIP_RULE, UDP_PKT, 0, 0, 0, 1);
}
