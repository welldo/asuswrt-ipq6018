...
3. Enter `git clone https://github.com/SWRT-dev/zenwifi-xp4` to download source code 
...
6. Then enter `cd ../zenwifi-xp4/release/src-qca-cypress` to enter folder

7. Enter `make pl-ax56_xp4` to start compiling the firmware

8. The firmware is in zenwifi-xp4/release/src-qca-cypress/image
